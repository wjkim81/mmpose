...
if __name__ == '__main__':
    ...
    annot_dict = {
        ...
        'big-flat-train': 'big-sidebranch-rnd_flat_train.json',
        'big-flat-test': 'big-sidebranch-rnd_flat_test.json',
        'big-round-train': 'big-sidebranch-rnd_round_train.json',
        'big-round-test': 'big-sidebranch-rnd_round_test.json',
    }
