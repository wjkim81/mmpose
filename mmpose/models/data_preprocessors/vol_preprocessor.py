...
class VolDataPreprocessor(BaseDataPreprocessor):
    ...
    def forward(self, data: dict, training: bool = False) -> Union[dict, list]:
        ...
        for i, d in enumerate(data):
            # print(f'data[{i}][inputs]:', data[i]['inputs'])
            _batch_inputs = data[i]['inputs']
            print('_batch_inputs:', _batch_inputs)
            ...
            data[i]['inputs'] = batch_inputs
            data[i].setdefault('data_samples', None)
        return data
