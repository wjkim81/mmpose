...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='sidebranch_round_train.v2_zero_label.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='sidebranch_round_test.v2_zero_label.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'sidebranch_round_test.v2_zero_label.json',
    nms_mode='none',
    score_mode='keypoint',
)
